...
namespace gcgcg
{
    class Mundo : GameWindow
    {
        ...
        private Primitivas obj_primitivasDoidas;
#if CG_Privado
    ...
    private Privado_Circulo obj_Circulo;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            objetoId = Utilitario.charProximo(objetoId);
            obj_primitivasDoidas = new Primitivas(objetoId, null, new Ponto4D(-200, -200, 0), new Ponto4D(200, 200, 0));           
            obj_primitivasDoidas.PrimitivaTamanho = 5;
            //obj_Circulo.PrimitivaTipo = PrimitiveType.Points; deixamos dentro da classe circulo, mas é possivel deixar aqui
            objetosLista.Add(obj_primitivasDoidas);
            objetoSelecionado = obj_primitivasDoidas;
      ...
      objetoSelecionado = obj_Circulo;
        ...
        protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
        {
            ...
            else if (e.Key == Key.E)
            {
                ...
                obj_primitivasDoidas.incrementaIndex();
            else
